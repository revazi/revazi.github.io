...
var showTBC = function() {
	console.log("showing tbc");
	$('body').removeClass('isOther');
	$('body').removeClass('loaded');
	$('body').removeClass('loading');
	$('body').addClass('isTBC');
	GLOBAL.setTimeout(function(){
		$('.Question-option--tbc .Text').removeClass('Hidden--withOpacity');
	}, 1000);
}

var showOther = function() {
	console.log("showing other");
	$('body').removeClass('isTBC');
	$('body').addClass('isOther').addClass('loading');
	GLOBAL.setTimeout(function(){
		if($('body').hasClass('isOther')) {
			$('body').removeClass('loading').addClass('loaded');
		}
		GLOBAL.setTimeout(function(){
			if($('body').hasClass('loaded')) {
				$('.Question-option--other .Text').removeClass('Hidden--withOpacity');
			}
		},1000);
	}, 5000)
	// window.setTimeout(function(){
...
},{"hashchange":3,"jquery":1}],3:[function(require,module,exports){
(function (global){
